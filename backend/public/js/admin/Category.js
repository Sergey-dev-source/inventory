...
/***/ "./resources/js/admin/component/CategoryTable.js":
/*!*******************************************************!*\
  !*** ./resources/js/admin/component/CategoryTable.js ***!
  \*******************************************************/
...
/* harmony export */   "default": () => (/* binding */ CategoryTable)
/* harmony export */ });
...
var CategoryTable = /*#__PURE__*/function (_Component) {
  ...
  function CategoryTable(plackeholderId, props) {
    var _this;
...
/***/ "./resources/js/admin/component/categoryEdit.js":
/*!******************************************************!*\
  !*** ./resources/js/admin/component/categoryEdit.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _component_Component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../component/Component */ "./resources/js/component/Component.js");
...
var categoryEdit = /*#__PURE__*/function (_Component) {
  ...
  function categoryEdit(placheholder, data) {
    var _this;

    _classCallCheck(this, categoryEdit);

    _this = _super.call(this, placheholder, data);
  ...
  _createClass(categoryEdit, [{
    ...
    value: function getSection() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/admin/getsection', {}).then(function (response) {
        _this2.categoryes = response.data;
      });
    }
  }, {
    key: "buildEvent",
    ...
    value: function saveCategory() {
      var validate = this.validateCategory();
    ...
    value: function deleteCategory() {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
        ...
        if (result.isConfirmed === true) {
          var id = _this3.refs.categoryId.value;

          _this3.triggerEvent('delete', {
            id: id
          });
        }

        _this3.$componentElem.modal('toggle');
      });
    }
  }, {
    key: "initSection",
    value: function initSection() {
      ...
      this.categoryes.forEach(function (element) {
        option += "<option value=\"".concat(element.id, "\" ").concat(data !== null && data.section_id === element.id ? 'selected' : '', ">").concat(element.name, "</option>");
      });
  ...
  return categoryEdit;
}(_component_Component__WEBPACK_IMPORTED_MODULE_1__["default"]);
...
/* harmony import */ var _component_categoryEdit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./component/categoryEdit */ "./resources/js/admin/component/categoryEdit.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _component_CategoryTable__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./component/CategoryTable */ "./resources/js/admin/component/CategoryTable.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var Category = /*#__PURE__*/function (_Component) {
  ...
  function Category(placheholder, data) {
    var _this;
  ...
  _createClass(Category, [{
    ...
    value: function getData() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default().get('/category/shows', {}).then(function (response) {
    ...
    value: function initial() {
      ...
      this.state = new _component_State__WEBPACK_IMPORTED_MODULE_1__["default"]('category', {
        data: {},
        events: {
          "new": function _new() {
            _this3.newCategory();
      ...
      this.categoryEdit = new _component_categoryEdit__WEBPACK_IMPORTED_MODULE_2__["default"]('categoryEdit', {
        data: {},
        events: {
      ...
      this.categoryTable = new _component_CategoryTable__WEBPACK_IMPORTED_MODULE_4__["default"]('category', {
        data: {},
        events: {
          edit: function edit(_ref4) {
            var detail = _ref4.detail;

            _this3.editCategory(detail);
          }
        }
      });
    }
    ...
    value: function persistData(check, data) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default().post(url, data).then(function (response) {
        ...
        _this4.categoryTable.table.ajax.reload();
      });
    }
  }, {
    key: "editCategory",
    value: function editCategory(detail) {
      var element;
