...
$(document).ready(function () {
  ...
  $('#table').DataTable({
    ...
    columns: [{
      ...
      render: function render(data, type, full, meta) {
        ...
        return "<input type=\"text\" data-arg=\"".concat(full.id, "\"  class=\"").concat(color, " text-white  btn coun\" value=\"").concat(data, "\" >");
      }
    }, {
      data: 'id',
      name: 'id',
  ...
  $('#table').on('keypress', 'input', function (e) {
    if (e.which === 13) {
      var _id = e.target.getAttribute('data-arg');

      var value = e.target.value;
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/inventory/counts', {
        id: _id,
        value: value
